# 🚀 Master Supabase Role-Based Access Control (RBAC): Update JWT Tokens with User Roles (Next.js SQL Guide)
...
## 🧩 Part 1: Supabase Setup and Nextjs Integration
...
2. Navigate to Authentication → Settings → Auth Hooks
